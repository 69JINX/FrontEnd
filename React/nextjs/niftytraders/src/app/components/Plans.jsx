                ...
                <thead>
                    <tr>
                        <th className='p-1 md:p-5'>
                            ...
                            <div className='text-[#999999] md:py-4 text-[10px] md:text-sm font-light text-left leading-5'>
                ...
                <tbody>
                    {
                        [
                            ...
                            <tr key={i}>
                                <td className={`p-1 md:p-5 text-[10px] lg:text-sm  ${poppins_sub.className}`}>
                                    {item.topic}
                                </td>
                                <td className={`text-center p-0 text-[10px] lg:text-sm ${poppins_sub.className}`}>
                                    {item.free}
                                </td>
                                <td className={`text-center text-[10px] lg:text-sm ${poppins_sub.className}`}>
                                    {item.month}
                                </td>
                                <td className={`text-center text-[10px] lg:text-sm ${poppins_sub.className}`}>
                                    {item.year}
